...
export default function Toast({message}) {
  ...
  return (
    <div id="toast-simple" className="flex items-center w-full max-w-xs p-10 space-x-5 text-iceTheme-300 bg-iceTheme-100 divide-x divide-iceTheme-300 rounded-lg shadow dark:text-iceTheme-100 space-x dark:bg-iceTheme-400" role="alert">
